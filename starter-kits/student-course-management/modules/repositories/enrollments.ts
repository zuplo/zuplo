...
/**
 * The Enrollment entity — the primary entity of this kit.
 *
 * An Enrollment ties a Student to a Course, tracks lifecycle
 * (`enrolled` → `completed` | `dropped` | `withdrawn`), and stores
 * the final letter grade once the course concludes.
 */
