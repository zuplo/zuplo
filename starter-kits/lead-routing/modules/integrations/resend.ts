 ...
 *
 * Used by lead routing to email the rep ("you got a new lead — Acme") and
 * optionally email the lead with a "thanks for reaching out" auto-reply.
 *
 * Env:
 *   RESEND_API_KEY      Bearer token from resend.com/api-keys
 *   RESEND_FROM_EMAIL   Default sender (e.g. inbound@yourdomain.com)
 */
