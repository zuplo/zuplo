 ...
 * `TWILIO_MESSAGING_SERVICE_SID` (recommended for production — handles
 * sender pool, sticky sender, fallback).
 *
...
export interface TwilioSmsRequest {
  ...
  body: string;
  /**
   * Optional override for sender. If unset, one of `TWILIO_FROM_NUMBER` or
   * `TWILIO_MESSAGING_SERVICE_SID` is used.
   */
  from?: string;
