 ...
 *
 * Used by the CRM kit to fire off follow-up emails: a rep clicks "send
 * recap" after a meeting, an LLM-drafted note goes out via Resend, and
 * the sent email gets logged back into /activities.
 *
 * Env:
 *   RESEND_API_KEY      Bearer token from resend.com/api-keys
 *   RESEND_FROM_EMAIL   Default sender (e.g. crm@yourdomain.com)
 */
