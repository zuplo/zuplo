...
/**
 * The Customer entity. The party billed for jobs.
 */
    ...
    case "firestore":
      return createRepository<Customer>({
        ...
        firestore: {
          ...
          collection:
            environment.FIRESTORE_CUSTOMERS_COLLECTION ?? "customers",
    ...
    case "upstash-redis":
      return createRepository<Customer>({
        ...
        upstashRedis: {
          ...
          keyPrefix: environment.UPSTASH_CUSTOMERS_KEY_PREFIX ?? "customers",
        },
      });
    case "neon":
      return createRepository<Customer>({
