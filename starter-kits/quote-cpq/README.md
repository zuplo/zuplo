...
- **New orchestrator MCP tool:** create a handler in `modules/mcp-tools/`, follow the pattern in `build-quote-from-requirements.ts` (use `invokeJson` from `@zuplo/starter-kit-shared/mcp`).
